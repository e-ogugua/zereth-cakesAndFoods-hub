...
const sizeOptions: Array<{id: string, name: string, servings: string, price: number, image: string}> = [
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="relative h-32 w-full mb-3 rounded-md overflow-hidden">
                        <OptimizedImage
                          src={typeof size.image === 'string' ? size.image.replace(/^//, '') : "placeholder.svg"}
                          alt={size.name}
                ...
                {decorationOptions.map((decoration) => (
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="relative h-32 w-full mb-3 rounded-md overflow-hidden">
                        <OptimizedImage
                          src={typeof decoration.image === 'string' ? decoration.image.replace(/^//, '') : "placeholder.svg"}
                          alt={decoration.name}
                          containerClassName="h-full w-full"
                          className="object-cover"
                        />
